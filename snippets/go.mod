module github.com/mrmxf/util/snippets

go 1.26

require (
	github.com/mrmxf/util/kfg v0.11.2
...
require (
	...
	github.com/mrmxf/util/crayon v0.11.0 // indirect
	github.com/mrmxf/util/scripts v0.11.0 // indirect
	github.com/mrmxf/util/slogger v0.11.0 // indirect
